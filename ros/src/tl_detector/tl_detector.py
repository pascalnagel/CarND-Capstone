...
class TLDetector(object):
    ...
    def image_cb(self, msg):
        ...
        if self.record_training_images:
            cv2img = self.bridge.imgmsg_to_cv2(self.camera_image, "bgr8")
            cv2.imwrite(self.training_image_dir+"{:0>6d}".format(self.training_image_counter)+"_"+str(state)+".jpg", cv2img)
